El script *0-current_working-directory* muestra la ruta de trabajo absoluta
El script *1-listit* muestra una lista de contenidos del directorio actual
El script *2-bring_me_home* caambia el directorio de trabajo al directorio home del usuario
